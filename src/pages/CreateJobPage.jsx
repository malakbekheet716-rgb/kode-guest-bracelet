...
// Fixed per-batch cap — no fetch, no dependency on prior batches. Every
// visit to this page starts clean at 1 / MAX_ALLOWED.
...
export default function CreateJobPage() {
  ...
  function adjust(delta) {
    applyQuantity((quantity === '' ? 0 : quantity) + delta);
  }
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (err.code === 'BATCH_LIMIT_EXCEEDED') {
        setFormError(t('errors.quantityTooHigh', { max: MAX_ALLOWED }));
        ...
        <form onSubmit={handleSubmit} noValidate>
          ...
          >
            <div className="stepper">
              ...
              />
              <button type="button" className="stepper__btn" onClick={() => adjust(1)} aria-label="increase">
                +
              </button>
            </div>
          </Field>
